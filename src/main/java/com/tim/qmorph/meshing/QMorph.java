package com.tim.qmorph.meshing;
...
import com.tim.qmorph.geom.MyVector;
import com.tim.qmorph.geom.Node;
import com.tim.qmorph.geom.Quad;
import com.tim.qmorph.geom.Ray;
import com.tim.qmorph.geom.Triangle;
import com.tim.qmorph.viewer.Msg;
...
public class QMorph extends GeomBasics {
    ...
    private int localUpdateFronts(Quad q, int lowestLevel, List<Edge> frontList2) {
        if (q.isFake) {
            ...
            int curLevelEdgesRemoved = 0;
            Edge e;
            ArrayList<Edge> lostFNList = new ArrayList<>();
            ArrayList<Edge> needsNewFN = new ArrayList<>();
            ArrayList<Edge> needsReclassification = new ArrayList<>();
