...
import com.tim.qmorph.meshing.Constants;
...
public class QMorphOptionsDialog extends Dialog implements ItemListener {
    ...
    TextField coinctol, movetolerance, obstol, deltafactor, mymin, thetamax, tol, gamma, maxiter;

    Label epsilon1Label, epsilon2Label;
    Label chevronMinLabel;
    Label coinctolLabel, movetoleranceLabel, obstolLabel, deltafactorLabel, myminLabel, thetamaxLabel, tolLabel,
    ...
    public QMorphOptionsDialog(Frame f) {// , String title, boolean modal) {
        ...
        topoContainer.add(chevronMinLabel = new Label("Minimum size of greatest angle in a chevron"));
